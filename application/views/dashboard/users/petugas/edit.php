            ...
            <div class="row">
              <div class="col-12">
                <div class="card animated fadeIn">
                  <form method="post" class="needs-validation" novalidate="" action="<?php echo site_url('users/petugas/edit/').$petugas->id_petugas; ?>">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <input type="text" class="form-control" name="username_petugas" placeholder="Rioprastiawan" value="<?php echo $petugas->username_petugas; ?>" required>
                      ...
                      <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          ...
                          <small class="form-text text-muted">Kosongkan password jika tidak ingin mengganti password</small>
                        </div>
                      </div>
                      <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          ...
                          <?php foreach($list_level as $ll): ?>
                              <option value="<?php echo $ll->id_level; ?>" <?php if($ll->id_level == $petugas->id_level){ echo "selected";} ?>><?php echo $ll->nama_level; ?></option>
                            <?php endforeach; ?>
                          </select>
                          <div class="invalid-feedback">
