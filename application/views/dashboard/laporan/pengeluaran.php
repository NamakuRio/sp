...
<body>
                ...
                <div class="card animated fadeIn">
                            ...
                            <div class="input-group">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="#" class="dropdown-item has-icon" target="_blank"><i class="far fa-file-pdf"></i> PDF</a>
                                        <a href="<?php echo site_url('laporan/createXLS'); ?>" class="dropdown-item has-icon"><i class="fas fa-file-excel"></i> EXCEL</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped" id="list-pengeluaran">
                        <thead>                                 
                          <tr>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        var t = $("#list-pengeluaran").dataTable({
