...
<body>
                ...
                <div class="card animated fadeIn">
                            ...
                            <div class="input-group">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="#" class="dropdown-item has-icon"><i class="far fa-file-pdf"></i> PDF</a>
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped" id="list-history-barang">
                        <thead>                                 
                          <tr>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        var t = $("#list-history-barang").dataTable({
