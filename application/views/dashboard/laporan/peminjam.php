              ...
              <div class="col-12">
                <div class="card animated fadeIn">
                  ...
                  <a href="<?php echo site_url('laporan'); ?>" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
                    <h4>Laporan Peminjam</h4>
                    <div class="card-header-action">
                        <div class="dropdown">
                            <a href="#" data-toggle="dropdown" class="btn btn-primary dropdown-toggle">Export</a>
                            <div class="dropdown-menu">
                                <a href="<?php echo site_url('laporan/peminjam/pdf'); ?>" target="_blank" class="dropdown-item has-icon"><i class="far fa-file-pdf"></i> PDF</a>
                                <a href="<?php echo site_url('laporan/peminjam/excel'); ?>" class="dropdown-item has-icon"><i class="fas fa-file-excel"></i> EXCEL</a>
                            </div>
                        </div>
                    </div>
                  </div>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        var t = $("#list-peminjam").dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "<?php echo site_url('laporan/getLaporan/peminjam'); ?>", "type": "POST"},
            columns: [
                {
                    "data": "id_petugas",
